from ._anvil_designer import Vystup_saw_komp_copyTemplate
from anvil import *
...
class Vystup_saw_komp_copy(Vystup_saw_komp_copyTemplate):
  """
...
"""
      ...
      for nazev_var, var_data in varianty.items():
        popis = (
          f" - {var_data.get('popis_varianty', '')}"
          if var_data.get("popis_varianty")
          else ""
        )
